...
//import static chapter17.AddressBook_Solution.loadObject;
import java.io.*;
 ...
 * @author Marcello
 */
public class AddressBook_Solution extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        Scene scene = new Scene(new BookPane().getPane(), 400, 150);
...
//new ObjectOutputStream(
    ...
    public BookPane() throws IOException {
