...
public class BankAccounts_Old extends JFrame {
  // Specify the size of five string fields in the record
  final static int NAME_SIZE = 32;
  final static int POSITION_SIZE = 32;
  final static int DEPARTMENT_SIZE = 32;
  final static int CITY_SIZE = 20;
  final static int STATE_SIZE = 2;
  final static int ZIP_SIZE = 5;
  final static int RECORD_SIZE =
    (NAME_SIZE + POSITION_SIZE + CITY_SIZE + STATE_SIZE + ZIP_SIZE);
  ...
  private JTextField jtfPosition = new JTextField(POSITION_SIZE);
  ...
  public void writeAddress() {
    try {
      ...
      FixedLengthStringIO.writeFixedLengthString(jtfPosition.getText(), POSITION_SIZE, raf);
      FixedLengthStringIO.writeFixedLengthString(
  ...
  public void readAddress(long position) throws IOException {
    ...
    String name = FixedLengthStringIO.readFixedLengthString(
      NAME_SIZE, raf);
    String street = FixedLengthStringIO.readFixedLengthString(POSITION_SIZE, raf);
  ...
  public static void main(String[] args) {
    BankAccounts_Old frame = new BankAccounts_Old();
    frame.pack();
    frame.setTitle("Bank Accounts");
